...
mysql_select_db("jadara",$con);
	...
	if($result) {
			...
			{ 
				...
				Print "<b>Comment:</b> ".$info['coment'] . "<br/>";
				?>
				<input type="checkbox" name="op[]" 
				value="<?php echo $info['com_id']; ?>" />Delete comment<hr/><br/>
<?php				
			} 
		}
		else echo "There are no comment.";
		?>
<input type="submit" name="submit" value="delete comment" />
&nbsp;&nbsp;&nbsp;&nbsp;
<br>
<p align="right">
<a href="new.html">اضافة تعليق</a></p>
		</form>
